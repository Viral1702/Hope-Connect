  ...
  return (
    <div className="bg-[#F5C28E] shadow-md border-b w-full sticky top-0 left-0 z-50">
      <nav className="container mx-auto flex items-center justify-between p-4">
        ...
        >
          <Link to="/allpost" className="block px-4 py-2 text-black font-semibold hover:text-[#ff6a00]">
            All Post
          </Link>
          <Link to="/network" className="block px-4 py-2 text-black font-semibold hover:text-[#ff6a00]">
            Network
          </Link>
          <Link to="/post" className="block px-4 py-2 text-black font-semibold hover:text-[#ff6a00]">
            Post
          </Link>
          <Link to="/notification" className="block px-4 py-2 text-black font-semibold hover:text-[#ff6a00]">
            Notification
          </Link>
